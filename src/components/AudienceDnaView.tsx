        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-1 text-2xl font-semibold text-white">
              <MetricLabel metric="audiencePersona">{t('audience')}</MetricLabel>
            </h2>
          ...
          <div key={persona.id} className="surface-panel space-y-4 p-5">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              ...
              <div className="surface-subtle p-3">
                <p className="text-[11px] text-slate-500">
                  <MetricLabel metric="purchasingPower">Purchasing power</MetricLabel>
                </p>
            ...
            <div className="surface-subtle p-4">
              <div className="flex items-center gap-2 text-xs font-medium text-slate-200">
                ...
                <MetricLabel metric="activeHours">Peak active hours</MetricLabel>
              </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2 text-xs font-medium text-slate-200">
                ...
                <MetricLabel metric="buyingTriggers">Buying triggers</MetricLabel>
              </div>
            ...
            <div className="rounded-2xl border border-indigo-400/20 bg-indigo-400/10 p-4 text-sm">
              <p className="eyebrow-label text-indigo-200">
                <MetricLabel metric="preferredFormat">Preferred content format</MetricLabel>
              </p>
